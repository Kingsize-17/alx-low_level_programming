...
/**
 * print_magic - This programm Prints the magic numbers of an ELF header.
 * @e_ident: The pointer to an array containing the ELF magic numbers.
 *
...
/**
 *  * print_version - This programm Prints the version of an ELF header.
 ...
 */
int main(int __attribute__((__unused__)) char *argv[])
{
	Elf64_Ehdr *header;
	int o, r;
